...
extlinks = {'grasscmd': ('http://grass.osgeo.org/grass80/manuals/%s.html', ''),
            ...
            'grass-script' : ('http://grass.osgeo.org/grass80/manuals/libpython/script.html#script.%s', ''),
            'pygrass-gis' : ('http://grass.osgeo.org/grass80/manuals/libpython/pygrass.gis.html#pygrass.gis.%s', ''),
            'pygrass-modules' : ('http://grass.osgeo.org/grass80/manuals/libpython/pygrass.modules.interface.html#pygrass.modules.interface.module.%s', ''),
            'pygrass-vector' : ('http://grass.osgeo.org/grass80/manuals/libpython/pygrass.vector.html#pygrass.vector.%s', ''),
            'pygrass-raster' : ('http://grass.osgeo.org/grass80/manuals/libpython/pygrass.raster.html#pygrass.raster.%s', ''),
...
.. |mActionMeasureArea| image:: {sep}{path}{sep}_static{sep}icons{sep}qgis{sep}mActionMeasureArea.png
   :width: {width}
.. |mActionMeasureBearing| image:: {sep}{path}{sep}_static{sep}icons{sep}qgis{sep}mActionMeasureBearing.png
   :width: {width}   
